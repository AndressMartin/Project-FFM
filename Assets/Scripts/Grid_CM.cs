...
public class Grid_CM
{
    ...
    public Grid_CM(int width, int height, float cellSize, Vector3 originPos)
    {
        this.width = width;
        this.height = height;
    ...
    //Sets the value with an X and Y
    ...
    //Sets the value with a world position
